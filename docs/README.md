...
SessionHarbor 的设计、架构与产品文档集中在此目录；根目录仅保留面向访客的 `README.md` 与社区文件。

## 从这里开始

| 文档 | 说明 |
|---|---|
| [项目开发文档.md](./项目开发文档.md) | 产品定位、竞品、架构、里程碑与权威进度（完整稿） |
...
- [assets/banner.svg](./assets/banner.svg) — README 顶部横幅
- [assets/logo.svg](./assets/logo.svg) — 项目图标
